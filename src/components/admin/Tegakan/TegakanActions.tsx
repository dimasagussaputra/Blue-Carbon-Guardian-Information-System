...
export default function TegakanActions({
  onAdd,
  search,
  status,
  spesies,
  ...
  async function handleExport(format: "pdf" | "excel") {
    ...
    try {
      ...
      if (spesies) params.set("spesies", spesies);

      const res = await fetch(`/api/tegakan/export?${params.toString()}`);
      ...
      a.href = url;
      a.download = `BCG-Tegakan-${Date.now()}.${format === "pdf" ? "pdf" : "xlsx"}`;
